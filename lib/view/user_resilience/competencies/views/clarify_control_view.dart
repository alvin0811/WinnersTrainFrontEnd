...
class ClarifyControlView extends StatelessWidget {
  const ClarifyControlView({super.key});
    ...
    return CustomBackground(
        child: Scaffold(
            ...
            appBar: const CustomAppBar(
              title: 'Clarify What’s in Your Control',
            ),
            ...
            bottomNavigationBar: Column(
              ...
              children: [
                ...
                CustomButton(
                  onPressed: () {
                    Navigator.pushNamed(
                        context, RoutesName.brainStormingView);
                  },
                  buttonText: 'Next',
                  width: 258.w,
                ),
