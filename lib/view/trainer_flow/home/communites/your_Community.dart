...
class YourCommunity extends StatelessWidget {
  const YourCommunity({super.key});
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(
                              context,
                              RoutesName.comyourrtressrelated,
                            );
                          },
                          child: Row(
                            children: [
        ...
        floatingActionButton: Opacity(
          ...
          child: Container(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.pushNamed(context, RoutesName.createthreads);
              },
              backgroundColor: Colors.transparent,
              elevation: 0,
